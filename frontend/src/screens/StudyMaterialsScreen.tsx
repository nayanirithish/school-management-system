        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {!selectedSubject ? (
            <>
              ...
              <BlurView intensity={70} tint="light" style={styles.classSelector}>
                <TouchableOpacity style={styles.classSelectorTouch} activeOpacity={0.7} onPress={toggleClassDropdown}>
                  ...
                  <MaterialCommunityIcons name={isClassDropdownOpen ? "chevron-up" : "chevron-down"} size={24} color="#6B7280" />
                </TouchableOpacity>
            ...
            <>
              ...
              <View style={styles.unitsContainer}>
                {Array.from({ length: selectedSubject.unitCount }).map((_, i) => (
                  <BlurView key={i} intensity={70} tint="light" style={styles.unitCard}>
                    ...
                    <TouchableOpacity style={styles.downloadButton} activeOpacity={0.7}>
                      <MaterialCommunityIcons name="download" size={20} color="#5B4BCA" />
